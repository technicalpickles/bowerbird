...
- Story file lives at `docs/bmad/implementation-artifacts/5-11-release-pipeline-end-to-end-verification.md` (matches sprint-status key `5-11-release-pipeline-end-to-end-verification`).
...
- [Source: docs/bmad/planning-artifacts/epics.md#Story 5.11] — story statement + 5 ACs (lines 1220-1248).
