...
4. **Release-notes merge plan:** the drafted narrative (`scratch/release-notes-v0.1.0.md`, deliberately uncommitted) gets prepended to the workflow-rendered body via `gh release edit v0.1.0 --notes-file` after the release job runs, preserving the generated tarball table and What's-Changed sections.
