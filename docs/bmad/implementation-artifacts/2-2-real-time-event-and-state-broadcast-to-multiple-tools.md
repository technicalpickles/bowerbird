...
- [ ] [Review][Patch] Make WS subscribe-readiness probes unique per attempt so delayed probe frames cannot leak into assertions [crates/daemon/tests/contract_daemon.rs:3087, crates/daemon/tests/contract_daemon.rs:3142, crates/daemon/tests/contract_daemon.rs:3190]
...
- [ ] [Review][Patch] Add an ingest-socket -> writer -> WS subscriber contract test so Story 2.2 covers the actual daemon ingress wiring [crates/daemon/src/ingest/writer.rs:23, crates/daemon/src/ingest/writer.rs:36, crates/daemon/tests/contract_daemon.rs:3280]
...
- [ ] [Review][Patch] Add a cross-topic ordering test for a client subscribed to both `events.*` and `state.session.*` [crates/daemon/src/projection/session.rs:172, crates/daemon/src/projection/session.rs:173, crates/daemon/tests/contract_daemon.rs:3305, crates/daemon/tests/contract_daemon.rs:3405]
